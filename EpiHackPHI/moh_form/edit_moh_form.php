...
$sql="SELECT * FROM phi where id='$phi_id'";
$result=mysqli_query($conn,$sql);
$row_phi=mysqli_fetch_assoc($result);
...
<!--      <tr>
      ...
      <tr>
        ...
        <td><select class="textbox w1 form-control text-uppercase" name="moh_area" id="moh_area">
                <option value="<?php echo $row_phi['moh_area'];?>"> <?php echo $row_phi['moh_area'];?> </option>
			  ...
			  <input type="text" name="pat_id" value="<?php echo $row_phi['pat_id']; ?>" hidden>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>:</td>
        <td>
        <input class="textbox w1 form-control text-uppercase" type="number" id="age_year"  name="age_year" placeholder="Year(s)" value="<?php echo $row_phi['pat_age'];?>"> <br/>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><button type="submit" class="btn btn-success"> <i class="glyphicon glyphicon-ok"></i> Submit </button> &nbsp;
