...
<body class="drawer drawer-right" onLoad="getTime()">
  ...
  <div id="master">
    ...
    <div id="nav" style="color:white" class="noPrint">
...
<div id="content" style="min-height:400px">
    <p align="right" class="printHead yesPrint"> Health 411 A</p>
    <p align="right" class="printHead yesPrint"> (F* 4S & E) 12/87</p>
    <p align="center" class="printHead yesPrint"> DEPARTMENT OF HELTH</p>
<p align="center" class="printHead"> COMMUNICABLE DISEASE REPORT- PART II (411A)</p>
<p align="center" class="printHead yesPrint"> <u>To be sent with weekly return of communicable disease to DHS</u></p>


<table width="80%" border="0" align="center" cellspacing="5" class="noPrint">
  <tr>
    <th scope="col">
...
<form method="post" action="add_moh_form.php" onSubmit="return checkPatientRegistrationForm()">
  ...
  <tr>
    <td ><table border="0" class="table t1">
      <tr>
         <td colspan="3" style="text-align:center"><span id="show" style="color:#FF0000"> </span></td>
      </tr>
      <tr>
        <td>Hospital ID</td>
        <td>:</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td  class="noPrint"><button type="submit" class="btn btn-success"> <i class="glyphicon glyphicon-ok"></i> Register </button> &nbsp;
    ...
    <div>
        <h5 style="text-align: center;">Signature of M.O.H.</h5>
    </div>
<br/>
  ...
  <br/><br/>
        ...
        <div id="footer" class="height35 noPrint">
