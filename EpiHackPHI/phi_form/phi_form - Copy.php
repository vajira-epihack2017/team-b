                    ...
                    <form action="add_phi_process.php" method="POST">
                        <div class="col-md-6">
                            <div class="form-group">
                                <!--<div class="col-md-6" style="padding-left:0px">-->
                                    ...
                                    <input id="phiRef"type="text" class="form-control" name="phi_ref" value="1">
                                <!--</div>-->
                                <!--<div class="col-md-6" style="padding-right:0px">-->
                                    <label for="mohNot">MOH Notification No:</label>
                                    <input id="mohNot"type="text" class="form-control" name="moh_not" value="2">
                                <!--</div>-->   
                                <label for="phiRan">PHI Range:</label>
                                <input id="phiRan"type="text" class="form-control" name="phi_ran" value="3">
                                <!--</div>-->
                                <!--<div class="col-md-6" style="padding-right:0px">-->
                                    <label for="mohArea">MOH/HO?Area:</label>
                                    <input id="mohArea"type="text" class="form-control " name="moh_area" value="4">
                            </div>
                        </div>
                    </div>
                        <hr>
                        <div class="form-group">
                            <div class="col-md-6" style="padding-left:0px">
                                ...
                                <input id="notified"type="text" class="form-control" name="notified" value="notified">
                            </div>
                            <div class="col-md-6" style="padding-right:0px">
                                <label for="notifiedDate">Date:</label>
                                <input id="notifiedDate"type="text" class="form-control " name="notified_date">
                            </div>   
                        </div>
                        <div class="form-group">
                            <div class="col-md-6" style="padding-left:0px">
                                <label>Disease as confirmed:</label>
                                <select name="conf_dis" class="form-control">
                            ...
                            <div class="col-md-6" style="padding-right:0px">
                                ...
                                <input id="confDate" type="text" class="form-control " name="conf_date">
                            </div>   
                        </div>
                        <div class="form-group">
                            <label for="patName">Name of Patient:</label>
                            <input id="patName"type="text" class="form-control" name="pat_name" value="patName">
                        </div>
                        <div class="form-group">
                            <label for="moveAddress">Patients movements three weeks prior to onset address:</label>
                            <textarea name="move_address" id="moveAddress" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6" style="padding-left:0px">
                                <label for="patAge">Age:</label>
                                <input id="patAge"type="number" class="form-control" name="pat_age" value="2">
                            </div>  
                            <div class="col-md-6" style="padding-right:0px">
                        ...
                        <div class="form-group">
                            <div class="col-md-4">
                                ...
                                <input id="onSetDate"type="text" class="form-control " name="onset_date">
                            </div>
                            <div class="col-md-4">
                                <label>Date of Hospitalization:</label>
                                <input id="hosDate"type="text" class="form-control " name="hos_date">
                            </div>
                            <div class="col-md-4">
                                <label for="disDate">Date of discharge:</label>
                                <input id="disDate"type="text" class="form-control " name="dis_date">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="labOut">Laboratory Findings Outcome:</label>
                            <textarea name="lab_out" id="labOut" class="form-control">Laboratory Findings Outcome</textarea>
                        </div>
                        <div class="form-group">
