...
$sql = "SELECT pat_sward as district_name, count(pat_sward) as count_d
FROM epihack.tbl_patient_data
WHERE pat_invdate BETWEEN '$from' AND '$to'
GROUP BY pat_sward";
...
$(function () {
    $('#container').highcharts({
        ...
        tooltip: {
            pointFormat: 'Registration : <b>{point.y:.0f}</b>'
        },
        series: [{
...
<h2 align="center"><strong>544 summary - ward wise</strong></h2>
<p align="center">&nbsp;</p>
