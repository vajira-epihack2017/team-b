...
<p align="center"><?php if(isset($_REQUEST['msg'])){
							...
							<table class="table table-striped table-bordered">
                                ...
                                <tbody>
									...
									<?php
										...
										//$sql="SELECT * FROM epihack.hospital_form";
										$sql="SELECT phi.id, phi.conf_date, phi.conf_dis, phi.created_by, phi.created_on  FROM phi LEFT JOIN moh ON phi.pat_id = moh.pat_id WHERE moh.pat_id IS NULL";
										...
										while($row544w=mysqli_fetch_array($result544)){
											...
											echo "<tr>";
											echo "<th>" . $p . "</th>";
											echo "<th>" . $row544w["conf_date"] . "</th>";
											
											echo "<th>" . $row544w["created_by"] . "</th>";
											echo "<th>" . $row544w["created_on"] . "</th>";
											echo " <th>

<a href='../moh_form/edit_moh_form.php?id=" . $row544w["id"] . "' class='btn btn-small btn-success'><i class='btn-icon-only icon-ok'> </i>Complete</a>

<a href='../moh_form/print_moh_form.php?id=" . $row544w["id"] . "' class='btn btn-small btn-primary'><i class='btn-icon-only icon-ok'> </i>print</a>
											 </th>";
											echo "</tr>";
										}
									?>
